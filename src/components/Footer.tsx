...
export default function Footer() {
  return (
    <footer className="relative mt-16 overflow-hidden bg-[#1f2937] px-[50px] pb-6 pt-10 text-white">
      <div className="relative z-10 grid gap-6 border-b border-white/15 pb-8 lg:grid-cols-[1.3fr_1fr]">
